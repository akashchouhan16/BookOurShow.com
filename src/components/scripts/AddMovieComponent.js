export default {
    ...
    methods: {
        movieinfo1() {
            ...
            if ((new Date(this.movieinfo.startDate).getTime() > new Date(this.movieinfo.endDate).getTime()) || (((new Date(this.movieinfo.startDate).getDate()) <= (today.getDate())) || ((new Date(this.movieinfo.endDate).getDate()) <= (today.getDate()))) || ((new Date(this.movieinfo.startDate).getTime() <= today.getTime()) || (new Date(this.movieinfo.endDate).getTime() <= today.getTime()))) {
                this.dateerror = true;
                this.fieldflag = true;
            }
            else {
