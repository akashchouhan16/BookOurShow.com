...
.display-userId, .display-name, .display-date, .display-movie, .display-slot, .display-seats, .display-price, .display-status, .display-ticket-meta{
    background-color: #222434;
    margin: .5em;
    padding: 1em;
    border-radius: 1em;
